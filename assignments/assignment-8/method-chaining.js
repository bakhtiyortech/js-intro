var result1 = "hello".includes("e").toUpperCase(); // true
var result2 = "world".indexOf("o").concat("cean"); // false
var result3 = "goodbye".endsWith("e").replace("e", "a"); // true
var result4 = "example".slice(0, 3).indexOf("a"); // false
var result5 = "space".trimStart().trimEnd().toUpperCase().slice(-1).toLowerCase(); // false
var result6 = "boolean".startsWith("b").toString().replace("true", "yes"); //false
var result7 = "JavaScript".toLowerCase().trim().concat(" is fun"); //true
